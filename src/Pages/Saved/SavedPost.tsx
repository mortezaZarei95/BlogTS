...
const Post = ({post} : Props) => {
  ...
  return(
    <div className={`border-2 w-[34rem] h-52 flex flex-col justify-between ${isSaved ? "bg-orange-400" : "bg-gray-100"}`}>
        ...
        <div className="flex justify-between  px-6 mb-3">
          ...
          <button onClick={handleSaving} className={` border-2 rounded-l w-28 h-10 ${isSaved ? "bg-gray-100" : "bg-orange-400"}`}>{isSaved ? "unsave" : "save"}</button>
